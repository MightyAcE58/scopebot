        ...
        <div className="relative isolate px-6 pt-14 lg:px-8 ">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              <h1
                className="text-balance text-3xl font-semibold text-transparent bg-clip-text sm:text-7xl drop-shadow-2xl"
                style={{
                  background:
                    "linear-gradient(135deg, #3B86C5 0%, #784BA0 57%,#FF3CAC 100%)",
              ...
              <p className="mt-9 text-pretty text-lg font-medium text-gray-700 sm:text-xl/8">
                Our AI{" "}
                <b className='text-purple-700 bg-gradient-animation"'>
                  ScopeBot
                </b>{" "}
                helps you gather requirements, define scope, choose the right
                tech stack, and estimate budgets and deadlines—all in one place.
                Simplify planning, save time, and bring your ideas to life
                effortlessly.
              </p>
                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                  <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                    ...
                    <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                      An AI-powered, mobile-friendly app for seamless project
                      planning and smarter team collaboration.
                    </p>
                  </div>
              ...
              <div className="relative max-lg:row-start-1">
                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                  <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                    ...
                    <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                      An app optimized for high performance, ensuring swift and
              ...
              <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
                  <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                    ...
                    <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                      Seamless performance meets uncompromising security,
                      safeguarding your project data every step of the way.
                    </p>
                  </div>
              ...
              <div className="relative lg:row-span-2">
                ...
                <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                  <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                    ...
                    <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                      Powerful APIs designed to integrate seamlessly and enhance
            ...
            <div className="mx-auto grid max-w-7xl gap-20 px-6 lg:px-8 xl:grid-cols-2 ">
              <div className="max-w-xl">
                ...
                <p className="mt-6 text-lg/8 text-gray-600">
                  We're a team of four passionate individuals driven by
                  creativity and dedication, working together to deliver
                  exceptional results and make your vision a reality.
                </p>
              </div>

              <ul
                role="list"
                className="grid gap-x-9 gap-y-12  sm:grid-cols-4 max-sm:grid-cols-1 sm:gap-y-16 xl:col-span-4 hover:backdrop-blur-md "
              >
                <li className="flex items-center gap-x-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold tracking-tight text-gray-900">
                      <a href="https://www.linkedin.com/in/vinaytilada/">
                        Vinay Tilada
                      </a>
                    </h3>
                ...
                <li className="flex items-center gap-x-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold tracking-tight text-gray-900">
                      <a href="https://www.linkedin.com/in/manaskolaskar/">
                        Manas Kolaskar
                      </a>
                    </h3>
                    <p className="text-sm font-semibold text-indigo-600">
                ...
                <li className="flex items-center gap-x-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold tracking-tight text-gray-900">
                      <a href="https://www.linkedin.com/in/khushi-thakur-259395300/">
                        Khushi Thakur
                      </a>
                    </h3>
                    <p className="text-sm font-semibold text-indigo-600">
                ...
                <li className="flex items-center gap-x-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold tracking-tight text-gray-900">
                      <a href="https://www.linkedin.com/in/codewithvansh-jain/">
                        Vansh Jain
                      </a>
                    </h3>
                    <p className="text-sm font-semibold text-indigo-600">
          ...
          <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <h2 className="text-center text-3xl/8 font-semibold text-gray-900">
                <b className="text-purple-700 text-gradient-animation">
                  {" "}
                  Technology{" "}
                </b>{" "}
          ...
          <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            <div class="sm:flex sm:items-center sm:justify-between">
              ...
              <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                ...
                <li>
                  <a
                    href="https://github.com/MightyAcE58/code-storm/blob/main/LICENSE"
                ...
                <li>
                  <a
                    href="https://github.com/MightyAcE58/code-storm"
